...
export default function EstimatorPage({
  ...
  if (!config) {
    return (
      <main className="flex flex-1 items-center justify-center bg-paper-0 px-4 py-20 text-center">
        <div>
          <p className="font-display text-xl font-semibold text-navy-950">
            We don&apos;t have an estimator for that yet.
          </p>
          <Link
            href="/estimators"
            className="mt-4 inline-block text-sm font-medium text-navy-950 hover:underline"
          >
  ...
  return <EstimatorForm config={config} />;
}

function EstimatorForm({ config }: { config: EstimatorConfig }) {
